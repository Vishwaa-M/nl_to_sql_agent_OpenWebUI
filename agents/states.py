...
# This file defines the central, enterprise-grade state object for our LangGraph agent.
# A robust state definition is critical for maintainability, debuggability, and ensuring
# type safety throughout the agent's execution flow. This TypedDict serves as the
# agent's "memory" or "working scratchpad," carrying all necessary information
...
class AgentState(TypedDict):
    ...
    # --- 1. Core Input & Conversation State ---
    # This section holds the initial user request and the ongoing conversation.
    ...
    # --- 2. Orchestration & Routing State ---
    # This section manages the agent's internal decision-making process.

    next_node: Optional[str]
    """The next node to execute, determined by a router or conditional edge."""
    
    # The HITL-related keys (awaiting_verification, user_response) have been removed
    # to create a fully autonomous agent workflow.

    # --- 3. Schema & Few-Shot Retrieval State ---
    # This section holds the context retrieved to help the LLM generate accurate SQL.
    ...
    # --- 4. SQL Generation & Execution State ---
    # This section tracks the lifecycle of the SQL query itself.
    ...
    # --- 5. Error & Correction State ---
    # This section is crucial for the agent's resilience and self-correction loop.
    ...
    # --- 6. Final Output & Visualization State (REFACTORED) ---
    # This section holds the human-readable results and the final visualization objects.
    ...
    # --- 7. Long-Term Memory State ---
    # This section manages the agent's ability to learn and recall information across sessions.
